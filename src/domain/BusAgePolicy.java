...
public enum BusAgePolicy {
    ...
    BusAgePolicy(IntPredicate agePredicate, int deductionFare, double discountRate) {
        this.agePredicate = agePredicate;
        this.deductionFare = deductionFare;
        this.discountRate = discountRate;
    }

    public static BusAgePolicy of(int age) {
        return Arrays.stream(BusAgePolicy.values())
